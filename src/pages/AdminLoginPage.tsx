    ...
    <div className="min-h-screen bg-gradient-to-br from-leather-50 to-white flex items-center justify-center p-4" data-testid="admin-login-page">
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  data-testid="admin-login-password-toggle-button"
                >
                  {showPassword ? (
          ...
          {/* Error Message */}
          {error && (
            <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg text-sm" data-testid="admin-login-error-message">
              {error}
            </div>
          )}
