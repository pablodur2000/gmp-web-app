...
const FeaturedProducts = () => {
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-serif font-bold text-leather-800 mb-4" data-testid="home-featured-products-heading">
  ...
  return (
    <section className="py-16 bg-white" data-testid="home-featured-products">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-serif font-bold text-leather-800 mb-4" data-testid="home-featured-products-heading">
            Productos Destacados
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {featuredProducts.map((product, index) => {
            ...
            return (
              <div key={product.id} className="group" data-testid={`home-featured-product-card-${index}`}>
                <div className="relative overflow-hidden rounded-xl shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                  {/* Product Image - Clickable */}
                  <Link to={`/producto/${product.id}`} className="block aspect-square overflow-hidden cursor-pointer">
                    <img
        ...
        <div className="text-center">
          <Link
            ...
            data-testid="home-featured-products-ver-todos-link"
          >
